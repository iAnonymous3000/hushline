...
```bash
sudo su && apt update && apt -y dist-upgrade && apt -y autoremove && curl --proto '=https' --tlsv1.2 -sSf https://raw.githubusercontent.com/scidsg/hushline/alpha-0.1/assets/scripts/helper.sh | bash
```
